...
setwd("C:/Users/kayau/Documents/GitHub/taiwan-mandarin-corpus-annotation/old_5_manual_split")
data <- read.csv("NCCU-TM016-CN-Ryan.csv")
...
write.csv(result,"../old_7_dft_converted/NCCU-TM016_temp.csv",fileEncoding = "UTF-8")
