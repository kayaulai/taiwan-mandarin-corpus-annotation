...
setwd("C:/Users/User/Documents/GitHub/taiwan-mandarin-corpus-annotation/6_final_split")
data <- read.csv("NCCU-TM049_Danni&Shujie Zhang.csv")
...
write.csv(result,"../7_dft_converted/NCCU-TM049.csv",fileEncoding = "UTF-8")
